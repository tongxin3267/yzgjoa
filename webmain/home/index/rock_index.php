...
$(document).ready(function(){
	...
	showrecord=function(html){        
		$('#recorddivshow').toggle();
		$('#recordcontent').html(html);
	}
	hideRecord=function(){ 
		$('#recorddivshow').fadeOut();
		return false;
	}
	...
	$('body').append('<div id="recorddivshow" style="display:none" class="box"><div class="title"><ul><li>&nbsp;<i class="icon-bell"></i>&nbsp;工作日志</li><li style="text-align:right"><a href="javascript:"><img src="images/wclose.png" onclick="return hideRecord()"></a>&nbsp;</li></ul></div><div id="recordcontent" style="height:130px;overflow:auto;padding:10px;text-align:left"></div></div>');
...
<div style="padding:10px;">
		...
		<tr valign="top">
				...
				<div class="panel panel-danger" style="display:none">
				  ...
				  <div class="panel-body">
						...
						<td>
							...
							<b>微信办公</b><br>&nbsp; &nbsp; 结合了Joy办公系统上IM无缝隙的对接会话交流，单据待办推送提醒，<a href="http://xh829.com/view_weixin.html" target="_blank">[详情介绍]</a>。<br>
			...
			<td style="padding-left:20px;">
				...
				<div class="panel panel-success"  style="display:none">
				  <div class="panel-heading">
					<h3 class="panel-title">关于Joy办公系统</h3>
				  </div>
				  <div class="panel-body">
					
					<div style="line-height:25px">
					软件：Joy办公系统<br>
					官网：<a href="http://www.yajoyo.com/" target="_blank">http://www.yajoyo.com/</a><br>
	...
	<div align="left" style="padding:0px 10px;display:none">
	...
	<div class="tishi" align="center">Copyright ©2016 技术支持：Joy办公系统开发团队</div>
