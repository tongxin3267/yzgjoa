...
$(document).ready(function(){
	var pid,optlx=0;
	var typeid=0,sspid=0,modenum='jzrgfee';
	var at = $('#optionview_{rand}').bootstree({
		url:js.getajaxurl('loadbookdatacourse','flow','main',{'setid':'60'}),
		columns:[{
	...
	var a = $('#view_{rand}').bootstable({
		...
		columns:[{
			...
			text:'项目名称',dataIndex:'title',editor:false,align:'left'
		},{
			text:'编号',dataIndex:'num'
		},{
			text:'工程监理',dataIndex:'author'
		},{
			text:'客户名称',dataIndex:'chuban'
		},{
			text:'确定日期',dataIndex:'cbdt'
		},{
			text:'价格',dataIndex:'price'
		},{
			text:'设计师',dataIndex:'designer'
		},{
			text:'客户地址',dataIndex:'weizhi'
		},{
			text:'说明',dataIndex:'explain'
		},{
			text:'审核进度',dataIndex:'coursename'
		},*//*{
			text:'',dataIndex:'opt',renderer:function(v,d,oi){
				return '<a href="javascript:;" onclick="openxiangs(\'项目\',\''+modenum+'\','+d.id+')">查看</a>';
			}
		}*/],
		itemclick:function(){
