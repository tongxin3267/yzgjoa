...
$(document).ready(function(){
	...
	var c = {
		...
		clickwin:function(o1,lx){
			...
			openinput('项目产品','goods', id, 'goodsrocks{rand}');
		},
		piliang:function(){
			managelistgoods = a;
			addtabs({num:'daorugoods',url:'flow,input,daoru,modenum=goods',icons:'plus',name:'导入项目'});
		},
...
<table width="100%"><tr>
	...
	<input class="form-control" style="width:150px" id="key_{rand}"   placeholder="项目名">
	</td>
	<td style="padding-left:10px">
