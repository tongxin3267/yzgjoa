		...
		addwin:function(o,lx){
			var h = $.bootsform({
				...
				items:[{
					...
					labelText:'应用ID',name:'agentid',required:true
				},{
					labelText:'secret管理密钥',name:'secret',required:true,type:'textarea',height:80
				},{
					labelText:'主页地址',name:'home_url',type:'textarea',height:80
				}],
				success:function(){
					a.reload();
				}
