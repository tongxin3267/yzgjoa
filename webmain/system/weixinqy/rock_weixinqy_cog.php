...
<div  style="padding:10px;">
		...
		<tr>
			...
			<td class="tdinput"><input id="weixinqycorpid_{rand}" class="form-control"></td>
		</tr>
		
		<tr>
			<td  align="right" width="180"><font color=red>*</font> 通讯录secret：</td>
			<td class="tdinput">
			<textarea id="weixinqysecret_{rand}" style="height:60px" class="form-control"></textarea>
		...
		<tr>
			...
			<td class="tdinput"><input placeholder="可不填" id="weixinqydeptid_{rand}" class="form-control"></td>
		</tr>
		...
		<tr>
			...
			<td class="tdinput"><input id="weixinqyhuitoken_{rand}" class="form-control"></td>
		</tr>

		<tr>
			<td  align="right">回调EncodingAESKey：</td>
			<td class="tdinput">
			<textarea id="weixinqyaeskey_{rand}" style="height:60px" class="form-control"></textarea>
